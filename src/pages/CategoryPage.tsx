    ...
    <main className="relative mx-auto flex w-full max-w-[640px] flex-col gap-[30px] overflow-x-hidden bg-white pb-[112px]">
      ...
      <header className="relative mx-auto mt-[100px] flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-white">{category?.home_services_count ?? 0} Services</p>
        </div>
      </header>
          ...
          >
            {filteredServices.length > 0
              ? filteredServices.map((service) => (
                  <SwiperSlide className="swiper-slide !w-fit" key={service.id}>
              ...
              : "Belum ada service yang tersedia."}
          </Swiper>
        </div>
      </section>
      <section
        ...
        <div className="flex flex-col gap-[14px]">
          ...
          {services.length > 0 ? (
            services.map((service) => (
              <Link key={service.id} to={`/service-details/${service.id}`}>
            ...
            <p className="pl-5 text-shujia-gray">
